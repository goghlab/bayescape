...
const Header1 = () => {
  ...
  return (
    <>
      {" "}
      <header className={`header  ${navbar ? "is-sticky bg-black" : ""}`}>
              ...
              <div className="d-flex items-center">
                ...
                <div className="d-flex items-center ml-20 is-menu-opened-hide md:d-none">
                  <Link
                    ...
                    className="button px-30 fw-400 text-14 -blue-1 bg-light-1 h-50 text-white"
                  >
                    加盟成為司機
                  </Link>
                  <Link
                    href="/others-pages/signup"
                    className="button px-30 fw-400 text-14 border-white -blue-1 h-50 text-light-2 ml-20"
                  >
                   立即叫車
                  </Link>
                </div>
