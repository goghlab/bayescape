...
const PopularDestinations = () => {
  const renderedSlides = destinations2.map((item, index) => (
    <SwiperSlide key={`swiper-slide-${item.id}-${index}`}>
      <Link href="#" className="citiesCard -type-1 d-block rounded-4" key={item.id}>
